...
class MapGrid(object):
    ...
    def plot(self, filename, rivers=True, **kwargs):
        print("Plotting")
    ...
    def name_places(self):
        ...
        # TODO: Naming!
        for city in self.cities:
            self.city_names[city] = "Testname " + str(np.random.random((1, 1)))  # self.lang.name("city")
        for region in np.unique(self.territories):
            self.region_names[region] = "Testname " + str(np.random.random((1, 1)))  # self.lang.name("region")
